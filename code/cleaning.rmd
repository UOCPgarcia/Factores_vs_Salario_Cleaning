...
Dado el estudio que se pretende hacer, y tras el estudio de las variables, se desestiman para el estudio la ganancia y pérdida de capital. La variable fnlwgt se dejará más adelante en un Análisis de Componentes Principales para ponderar si aporta o no al estudio.
...
```{r}
boxplot ( datos$education.num,
          main="Número de años de estudios")
```
...
Dado el elevado número de datos, se estudiaría la posibilidad de aplicar el teorema del límite central.
