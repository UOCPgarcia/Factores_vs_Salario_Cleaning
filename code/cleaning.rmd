...
### Normalización (no creo que sea necesario)
...
```{r}
data(datos, package = "mlbench")
bc <- datos[complete.cases(datos),]
m4 <- glm(salary50k ~ ageIndividual + educationNum + raceIndividual + sexIndividual + 
            hoursPerWeek, data= bc, family = "binomial")
summary(m4)
```
