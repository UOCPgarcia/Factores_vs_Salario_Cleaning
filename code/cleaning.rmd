...
```{r}
table(unmodifiedDatos$sex,datosOrigen$salary)
```
...
```{r}
# sex-puesto de trabajo-salary
qplot(salary, data = unmodifiedDatos, fill = workclass)+ facet_grid (. ~ sex)
```

```{r}
# race-salary
qplot(salary, data = unmodifiedDatos, fill = race)
